 ...
 * val customLoginScreenContent = LoginScreenContent(
 ...
 * println(customLoginScreenContent.heading) // Output: "Welcome to Our App"
 * println(customLoginScreenContent.emailPlaceholder) // Output: "user@example.com"
 *
...
data class LoginScreenContent(
     ...
     * Example:
     * ```kotlin
     * val registerButtonSupporedText = "Don't have an account?"
     * ```
     */
    val registerButtonSupporedText: String = "Don't have an account?",
    ...
    /**
     * The label for the "Forgot Password" button.
     *
     * This string is displayed as a clickable link to allow users to reset their password.
     *
     * Example:
     * ```kotlin
     * val forgotPasswordButtonLabel = "Forgot Password?"
     * ```
     */
    val forgotPasswordButtonLabel: String = "Forgot Password?",
    ...
    constructor(stringResourceProvider: StringResourceProvider) : this(
        ...
        registerButtonSupporedText = stringResourceProvider.newToApp,
        appName = stringResourceProvider.appName,
        forgotPasswordButtonLabel = stringResourceProvider.forgot,
